...
-- ------------------------------------------------------- subscription plans
-- Legacy per-account plan column (superseded by practices.plan + the
-- BILLING section below — Stripe billing landed 2026-07-18). AI proxying
-- + usage/costs recorded server-side.
