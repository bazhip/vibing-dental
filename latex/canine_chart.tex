...
\newcommand{\gc}[1]{\TextField[name=#1,width=0.235in,height=0.14in,borderwidth=0]{}}
% Grid cell with gray background (used for canine C columns)
\newcommand{\gcc}[1]{\TextField[name=#1,width=0.235in,height=0.14in,borderwidth=0,backgroundcolor={0.85 0.85 0.85}]{}}
...
\begin{tikzpicture}[remember picture, overlay,
  ...
  % --- TITLE: "Canine Dental Chart" (top-right) -----------------------------
