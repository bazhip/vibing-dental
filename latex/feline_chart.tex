...
\newcommand{\gc}[1]{\TextField[name=#1,width=0.290in,height=0.14in,bordercolor={0 0 0},borderwidth=0]{}}
% Grid cell with gray background (used for canine C columns)
\newcommand{\gcc}[1]{\TextField[name=#1,width=0.290in,height=0.14in,bordercolor={0 0 0},borderwidth=0,backgroundcolor={0.85 0.85 0.85}]{}}
...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \node[anchor=north west] at ([xshift=6.70in, yshift=-0.50in]current page.north west) {%
    \TextField[name=treatment_report, multiline=true,
               ...
               borderwidth=0.5, bordercolor={0 0 0},
               value=]{}};
