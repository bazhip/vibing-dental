...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \node[anchor=north west] at ([xshift=3.65in, yshift=-0.30in]current page.north west) {%
    ...
    \begin{tabular}{|L{1.05in}|L{2.40in}|}
      ...
      Doctor:          & \TextField[name=doctor, width=2.40in, height=0.16in, borderwidth=0, value={Margaret Smith}]{} \\ \hline
      Tech:            & \TextField[name=tech,   width=2.40in, height=0.16in, borderwidth=0]{} \\ \hline
